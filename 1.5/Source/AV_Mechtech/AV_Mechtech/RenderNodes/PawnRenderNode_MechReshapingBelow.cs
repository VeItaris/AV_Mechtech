...
namespace AV_Mechtech
{
    ...
    public class PawnRenderNode_MechReshapingBelow : PawnRenderNode_AnimalPart
    {
        public PawnRenderNode_MechReshapingBelow(Pawn pawn, PawnRenderNodeProperties props, PawnRenderTree tree) : base(pawn, props, tree)
        {
        ...
        public static string Path = "Things/Pawn/Mechanoid/AV_Reshaper/AV_Sinistrepower_Background";

        public static string Path_Overtake = "Things/Pawn/Mechanoid/AV_Reshaper/AV_Overtake_Background";
        ...
        public override Graphic GraphicFor(Pawn pawn)
        {
            ...
            //Log.Message("returning null graphic for PawnRenderNode_MechReshapingBelow");
            return null;
