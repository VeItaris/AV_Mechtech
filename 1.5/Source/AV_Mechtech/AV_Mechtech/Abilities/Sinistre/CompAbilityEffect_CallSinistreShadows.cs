...
{
    public class CompAbilityEffect_CallSinistreShadows : CompAbilityEffect
    {
        public new CompProperties_AbilityCallSinistreShadows Props => (CompProperties_AbilityCallSinistreShadows)props;
        ...
        public readonly int ResourceCostPerCast = SinistreUtility.ResourceCost_CallSinistreShadows;

        public readonly int PowerStageNeeded = SinistreUtility.PowerStageNeeded_CallSinistreShadows;
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            wanderingSinistre.SpawnSinistreShadows();   //already uses resources
        }
