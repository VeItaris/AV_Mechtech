...
{
    public class CompAbilityEffect_CallSinistre : CompAbilityEffect
    {
        public new CompProperties_AbilityCallSinistre Props => (CompProperties_AbilityCallSinistre)props;
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            ResourceHolder.UseResources(ResourceCostPerCast);
            wanderingSinistre.SpawnSinistre();
        }
